...
async def move_monster(client: SFSServerClient, params: SFSObject):
    ...
    update_resp = SFSObject().putBool("success", True).putLong("user_monster_id", user_monster_id)
    ...
    update_resp.putFloat("volume", user_monster.volume)
...
async def sell_monster(client: SFSServerClient, params: SFSObject):
    ...
    return SFSObject().putBool('success', True).putLong('user_monster_id', user_monster_id).putSFSArray(
...
async def collect_monster(client: SFSServerClient, params: SFSObject):
    ...
    update_response = SFSObject().putBool("success", True).putLong("user_monster_id", user_monster_id)
